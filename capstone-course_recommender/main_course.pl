...
main :-
  reconsult('kb_course.pl'),nl,
  reconsult('questions_course.pl'),nl,
  reconsult('answer_course.pl'),nl,
  reconsult('describe_course.pl'),nl,
  reconsult('assign_course.pl'),nl,
  intro,
  reset_answers,
  find_course(Course),
  describe_course(Course), nl.
